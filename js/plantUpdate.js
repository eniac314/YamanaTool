...
Elm.PlantUpdate = Elm.PlantUpdate || {};
Elm.PlantUpdate.make = function (_elm) {
   "use strict";
   _elm.PlantUpdate = _elm.PlantUpdate || {};
   if (_elm.PlantUpdate.values) return _elm.PlantUpdate.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   var subMenu = _U.list([]);
   return _elm.PlantUpdate.values = {_op: _op
                                    ,subMenu: subMenu
                                    ,Model: Model
